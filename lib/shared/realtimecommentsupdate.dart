...
class RealTimeCommentUpdates extends StatelessWidget {
  final String docid;
  final social;
  RealTimeCommentUpdates({required this.docid, this.social, required comment});
  @override
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: moduleComplaintUserComments.snapshots() as Stream<QuerySnapshot<Map<String, dynamic>>> ,
